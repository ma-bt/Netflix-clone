...
async function runTemplateWorker({
  ...
  const worker = (0, _child_process.fork)(_path.default.join(__dirname, "..", "..", "scripts", "read-theme-file.worker.js"), [themeFile].concat(strictComponentTypes ? "--strict-component-types" : []).concat(format ? "--format" : []), {
